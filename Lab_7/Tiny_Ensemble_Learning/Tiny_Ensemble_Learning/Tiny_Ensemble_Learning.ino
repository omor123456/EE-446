...
extern const unsigned int encoder_clf_raw_pruned_qat_int8_tflite_len;

extern const unsigned char encoder_clf_std_pruned_qat_int8_tflite[];
extern const unsigned int encoder_clf_std_pruned_qat_int8_tflite_len;

extern const unsigned char encoder_clf_minmax_pruned_qat_int8_tflite[];
extern const unsigned int encoder_clf_minmax_pruned_qat_int8_tflite_len;

extern const unsigned char stacked_meta_clf_pruned_qat_int8_tflite[];
extern const unsigned int stacked_meta_clf_pruned_qat_int8_tflite_len;
